...
/* end template */
    ...
    {'github_user': 'EternalWitness',
           'date': new Date(2011,12,19),
         'comment': "This is an interesting way to do comments on Jekyll, but you're right, this is 
rather difficult for most people. I am looking for ways to implement comments on our Jekyll blog, but I'll probably 
end up using Disqus. The other thing to consider is that anyone can create a fork and edit other people's comments..."},]
